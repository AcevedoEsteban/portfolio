  ...
  return (
    ...
    <div className="h-full w-full relative flex flex-col items-start gap-5 overflow-hidden">
      ...
      <div className="flex flex-col gap-3 text-gray-300">
        ...
        <p className=" font-poppins text-xl w-full text-gray-300 max-sm:text-lg">
      ...
      <div className="block">
        <h1 className="gap-2 text-3xl font-poppins text-custom-white font-semibold flex icon_underline relative max-sm:text-2xl">
          {" "}
        ...
        <div className="w-full h-fit p-2 flex flex-row justify-between gap-7 max-lg:flex-col">
          {items.map((val, indx) => {
            return (
              <div
                key={indx}
                className="flex gap-2 justify-center items-center flex-row text-xl text-gray-300 pt-3 max-lg:justify-start "
              >
